        ...
        <div id="header">
            ...
            <div class="card">
                <div class="card-header">
                    <div class=" nav-flex-icons" style={{float:"right" }}>
                        <Button onClick = {logoutHandler} variant="outlined"><i class="fa fa-sign-in" aria-hidden="true" style = {{marginRight:"5px"}}></i>LogOut</Button> 
                    </div>
                </div>
            </div>
            <hr class="my-4"></hr>
