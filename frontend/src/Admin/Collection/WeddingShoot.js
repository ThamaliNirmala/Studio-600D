...
const WeddingShoot = ()=>{
    ...
    const weddingShootHandler = async (e)=>{
        ...
        try {
            const {data} = await axios.post("http://localhost:8070/weddingShoot/add" , {coupleName , imgURL1 , imgURL2 , imgURL3 , collectionURL , downloads , likes , unLikes , category, password} , config);
