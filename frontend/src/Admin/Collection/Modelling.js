...
const Modelling = ()=>{
    ...
    const modellingHandler = async (e)=>{
        ...
        try {
            const {data} = await axios.post("http://localhost:8070/modelling/add" , {modelerName , imgURL1 , imgURL2 , imgURL3 , collectionURL , downloads , likes , unLikes , category, password} , config);
