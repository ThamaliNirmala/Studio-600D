...
export default class PreShootTableRow extends Component {
    ...
    deleteAssistant() {
        axios.delete('http://localhost:8070/preShoot/delete/' + this.props.obj._id)
            .then((res) => {
                toast("Success! PreShoot Collection Deleted 😘")
            }).catch((error) => {
                console.log(error)
            })
