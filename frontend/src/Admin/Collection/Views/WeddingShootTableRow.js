...
export default class WeddingShootTableRow extends Component {
    ...
    deleteAssistant() {
        axios.delete('http://localhost:8070/weddingShoot/delete/' + this.props.obj._id)
            .then((res) => {
                toast("Success! WeddingShoot Collection Deleted 😘")
            }).catch((error) => {
                console.log(error)
            })
