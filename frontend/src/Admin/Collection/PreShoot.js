...
const PreShoot = ()=>{
    ...
    const preShootHandler = async (e)=>{
        ...
        try {
            ...
            toast("Error! PreShoot Collection not Added Duplicate Key Found: Couple Name must be unique")
            setLoading(false);
            setIsError(true);
            setTimeout(()=>{
    ...
    return(
        <div>
            <form onSubmit={preShootHandler}>
                    <div className="card">
                        <div className="card-body">
                            <center>
                                <h5 className="card-title">Add PreShoot Photo Collection</h5>
                                <TextField
