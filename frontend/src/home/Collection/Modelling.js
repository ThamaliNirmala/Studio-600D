    ...
    handleInputChange = event => {
      ...
      this.setState(prevState => {
        const filteredData = prevState.data.filter(element => {
          return element.modelerName.toLowerCase().includes(query.toLowerCase());
        });
                ...
                <nav className="nav">
                    <ul className="ul">
                        <center>
                            ...
                            <li className="li"><Link className="active" to="/modelling">Modelling</Link></li>
                                ...
                                <div style={{display:"inline-block" , padding: "10px 1px 10px 10px"}}>
                                    <center>
                                        <div className="card border-primary mb-3" > 
                                            ...
                                            <img src={i.imgURL1} border="0'" alt={i.modelerName} className="img-thumbnail zoom" style={{width:"200px" , height:"300px", marginTop: "20px", marginRight:"25px", marginLeft:"10px"}}/>
                                            <img src={i.imgURL2} border="0'" alt={i.modelerName} className="img-thumbnail zoom" style={{width:"200px" , height:"300px", marginTop: "20px", marginRight:"25px"}}/>
                                            <img src={i.imgURL3} border="0'" alt={i.modelerName} className="img-thumbnail zoom" style={{width:"200px" , height:"300px", marginTop: "20px", marginRight:"10px"}}/>
                                            <br/><br/>
