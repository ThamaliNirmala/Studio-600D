                ...
                <nav className="nav">
                    <ul className="ul">
                        <center>
                            ...
                            <li className="li"><Link className="active" to="/goingaway">HomeComming </Link></li>
