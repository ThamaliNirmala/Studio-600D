...
export default class Item extends React.Component {
    ...
    getData = () => {
      fetch(`http://localhost:8070/weddingShoot`)
                ...
                <nav className="nav">
                    <ul className="ul">
                        <center>
                            ...
                            <li className="li"><Link className="active" to="/weddingshoot">Wedding Shoot</Link></li>
                                ...
                                <div style={{display:"inline-block" , padding: "10px 1px 10px 10px"}}>
                                    <center>
                                        <div className="card border-primary mb-3" > 
                                            ...
                                            <img src={i.imgURL1} border="0'" alt={i.coupleName} className="img-thumbnail zoom" style={{width:"200px" , height:"300px", marginTop: "20px", marginRight:"25px", marginLeft:"10px"}}/>
                                            <img src={i.imgURL2} border="0'" alt={i.coupleName} className="img-thumbnail zoom" style={{width:"200px" , height:"300px", marginTop: "20px", marginRight:"25px"}}/>
                                            <img src={i.imgURL3} border="0'" alt={i.coupleName} className="img-thumbnail zoom" style={{width:"200px" , height:"300px", marginTop: "20px", marginRight:"10px"}}/>
                                            <br/><br/>
