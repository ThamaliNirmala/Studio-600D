...
export default class Item extends React.Component {
    ...
    getData = () => {
      fetch(`http://localhost:8070/preShoot`)
                ...
                <nav className="nav">
                    <ul className="ul">
                        <center>
                            ...
                            <li className="li"><Link className="active" to="/preshoot">Pre Shoot</Link></li>
