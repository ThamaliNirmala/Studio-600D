    ...
    return (
        ...
        <footer className="bg-dark text-center text-white">
            ...
            <div className="container p-4 pb-0" style = {{top:"100px"}}>
                ...
                {/*<!-- Facebook -->*/}
                <a className="btn btn-outline-light btn-floating m-1" href="https://www.facebook.com/studio600d" role="button" target = "_blank"><i className="fa fa-facebook" aria-hidden="true" style = {{marginTop:"10px"}}></i></a>
                ...
                {/*<!-- Instagram -->*/}
                <a className="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/studio_600d/" role="button" target = "_blank"><i className="fa fa-instagram" aria-hidden="true" style = {{marginTop:"10px"}}></i></a>
