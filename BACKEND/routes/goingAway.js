...
router.route("/update/:id").put(async (req , res)=>{  //update data
    ...
    const updateGoingAway = {coupleName , imgURL1 , imgURL2 , imgURL3 , collectionURL , category, password, downloads, likes, unLikes};

    await GoingAway.findByIdAndUpdate(GoingAwayID , updateGoingAway)
    .then(()=>{
