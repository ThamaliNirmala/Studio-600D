...
router.route("/update/:id").put(async (req , res)=>{  //update data
    ...
    const updateModelling = {modelerName , imgURL1 , imgURL2 , imgURL3 , collectionURL , category, password, downloads, likes, unLikes};

    await Modelling.findByIdAndUpdate(ModellingID , updateModelling)
    .then(()=>{
